...
This function library wraps that command with arithmatic function for quick comman-line access.
...
- a very good rational approximaation of PI:
...
- `Environment` -- the memory of the current Shell process.  Includes variable and functions.
