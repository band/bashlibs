...
1. A `family` is a collection of functions sharing a naming
   ...
   Many sub-function names are hardly uniqueokl. Such are *init, help,
   test, doc,* and *list*.  Sub-names may occasionally use a sub name.
   For exaample, *fam_sub_test*.  A family of functions will typically
...
of any type. Here as [The Only Backup You'll EverNeed](./Backup.html).
Its use promotes a [SimpleVersioning](./SimpleVersion.html) system.
