-   [A Quick Simple
    Version](#a-quick-simple-version){#toc-a-quick-simple-version}
    -   [1 Introduction](#sec-1){#toc-sec-1}
    -   [2 The backup](#sec-2){#toc-sec-2}
    -   [3 The Code](#sec-3){#toc-sec-3}
    -   [4 The version](#sec-4){#toc-sec-4}
    -   [5 references](#sec-5){#toc-sec-5}

# A Quick Simple Version
...
This paper is part of my [Commonplace
Book](http://mcgowans.org/pubs/marty3/commonplace/book.html)

This implementation is based on the [backup system discussed
here.](file:///Users/applemcg/Dropbox/commonplace/software/backupfunction.html)
...
[]{#text-3} For the moment, here is the [backup
code](../software/backupfunction.html)
...
1.  [The Commonplace Book](../book.html)

2.  Korn Shell author:
    [davekorn](http://en.wikipedia.org/wiki/David_Korn_(computer_scientist))

[]{#postamble} Author: Marty McGowan

Created: 2016-11-19 Sat 18:48
