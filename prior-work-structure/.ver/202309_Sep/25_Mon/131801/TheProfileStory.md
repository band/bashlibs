...
It's about how to organize your profile, the commands to setup your
working environment.
...
Here is this folder's [Table of Contents](./index.html)  
...
In the  spirit of  "do nothing politely",  this bash_profile  has two
...
The  `unset` command,  a  built-in unsets  or  clears any  Environment
Variables   and  function   definitions  This   instance  clears   any
environment variables.  I've  a utility which, if  necessary can clear
all the function definitions as well.
...
Where the  first optional feature  is invoked, *sourcing*  an existing
user_profile.  The file is read into the shell's memory (Environment).
